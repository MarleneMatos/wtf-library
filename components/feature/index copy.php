...
<head>
  ...
  <link rel="canonical" href="https://library.webtechfocus.com/components//feature/" />
</head>
...
<body id="wtfTheme" class="wtf-line">
  ...
  <main>
    ...
    <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?> px-4 py-5" id="featured-3">
      <h3 class="h1 wtf">Columns with icons</h3>
      <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
        ...
        <div class="feature col">
          <div
            class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
            <svg class="bi" width="1em" height="1em" aria-hidden="true">
              <use xlink:href="../../../wtf-library/wtf-theme-assets/icons/icomoon-free490/sprite.svg#icon-stack"></use>
            </svg>
          </div>
          <h3 class="fs-2 text-body-emphasis">Featured title</h3>
          <p>
    ...
    <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?> px-4 py-5" id="hanging-icons">
      <h3 class="h1 wtf">Hanging icons</h3>
      <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
    ...
    <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?> px-4 py-5" id="custom-cards">
      <h3 class="h1 wtf">Custom cards</h3>
          ...
          <div
            ...
            <div
              ...
              <ul class="d-flex list-unstyled mt-auto">
                <li class="me-auto">
                  <img
                    src="../../../wtf-library/wtf-theme-media/wtf-wtf/brand/wtf-logo-2026-wbg.png"
                    alt="Bootstrap"
                    width="32"
                    height="32"
    ...
    <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?> px-4 py-5">
      <h3 class="h1 wtf">Features with title</h3>
      <div
