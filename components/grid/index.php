...
<html lang="en" data-bs-theme="auto">
  ...
  <link rel="canonical" href="http://localhost/wtf-library/components/list-groups/" />
    <link
      rel="canonical"
      href="https://library.webtechfocus.com/components/grid/"
    />
 ...
 <body id="wtfTheme" class="wtf-line py-4">
  <?php include(SITE_ROOT . '/components/header/wtf-theme.php'); ?>
    ...
    <main>
      ...
      <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?>" id="containers">
        <hr class="my-4" />
      ...
      <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?> themed-container text-center">.container</div>
      ...
      <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?> themed-container text-center">
        .container-fluid
      </div>
    </main>
