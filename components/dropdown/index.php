...
<head>
  ...
  <link rel="canonical" href="https://library.webtechfocus.com/components/dropdowns/" />
  ...
  <main>
    ...
    <div
      ...
      <ul
        ...
        <li>
          <a
            class="dropdown-item dropdown-item-danger d-flex gap-2 align-items-center"
            href="#">
            <svg class="bi" width="16" height="16" aria-hidden="true">
      ...
      <ul
        class="dropdown-menu d-block position-static mx-0 border-0 shadow w-220px">
        <li>
          <a class="dropdown-item d-flex gap-2 align-items-center" href="#">
            <svg class="bi" width="16" height="16" aria-hidden="true">
              <use xlink:href="#files"></use>
    ...
    <div
      class="d-flex flex-column flex-md-row p-4 gap-4 py-md-5 align-items-center justify-content-center">
      <div
        class="dropdown-menu d-block position-static p-2 mx-0 shadow rounded-3 w-340px"
        data-bs-theme="light">
          ...
          <nav>
            <ul class="d-flex flex-column gap-2 list-unstyled small">
              ...
              <li>
                <a
                  href="#"
                  class="link-offset-2 link-underline link-underline-opacity-25 link-underline-opacity-75-hover">Use cases</a>
              </li>
              <li>
                <a
                  href="#"
                  class="link-offset-2 link-underline link-underline-opacity-25 link-underline-opacity-75-hover">API status</a>
              </li>
              <li>
                <a
                  href="#"
