...
<html lang="en" data-bs-theme="auto">
  ...
  <link rel="canonical" href="http://localhost/wtf-library/components/list-groups/" />
    
    <link
      rel="canonical"
      href="https://library.webtechfocus.com/components/headers/"
    />
  ...
  <!--
    ...
    <main>
        ...
        <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?>">
          ...
          >
            ...
            <div class="dropdown text-end">
              ...
              >
                <img
                  src="/wtf-library/logos/wtf-logo-square-wbg.png"
                  alt="webtechfocus"
                  width="32"
                  height="32"
      ...
      <header class="py-3 mb-3 border-bottom">
        <div
          class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?> d-grid gap-3 align-items-center"
      ...
      <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?> pb-3">
      ...
      <nav class="py-2 bg-body-tertiary border-bottom">
        <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?> d-flex flex-wrap">
      ...
      <header class="py-3 mb-4 border-bottom">
        <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?> d-flex flex-wrap justify-content-center">
          <a
            href="/"
