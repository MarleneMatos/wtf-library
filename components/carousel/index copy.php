...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <title>Carousel Template <?php include(SITE_ROOT . '/components/wtf/wtf-wtf-title.php'); ?></title>
    <link
      rel="canonical"
      href="https://library.webtechfocus.com/components/carousels/"
    />
...
<?php include(SITE_ROOT . '/components/wtf/wtf-gtm-body.php'); ?>
  ...
  ================================================== -->
      ...
      <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?> marketing">
      ...
      <!-- /.container -->
      <!-- FOOTER -->
      <footer class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?>">
