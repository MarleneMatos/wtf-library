...
<head>
    ...
    <link rel="canonical" href="https://library.webtechfocus.com/components/accordions/" />
</head>

<body id="wtfTheme" class="wtf-line">
    <?php include(SITE_ROOT . '/components/header/wtf-theme.php'); ?>

    <main id="wtfAccordion">
        <?php include(SITE_ROOT . '/components/accordions/section.php'); ?>
    </main>
