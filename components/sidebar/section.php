    <section class="<?php include(SITE_ROOT . '/components/content/demo/section-class.php'); ?> "id="sidebar" class="my-5">
        <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?>">
            <div class="row my-5">
                <h3 class="h1 wtf">Sidebars</h3>

            </div>

            <div class="d-flex flex-nowrap">
                <div class="divider--xl-vr"></div>
                <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
                    ...
                    <div class="dropdown">
                        <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="https://theme.webtechfocus.com/assets/logos/wtf-logo-square-bbg.svg" alt="" width="32" height="32" class="rounded-circle me-2">
                            <strong>mm</strong>
                        </a>
                ...
                <div class="d-flex flex-column flex-shrink-0 bg-body-tertiary" style="width: 4.5rem;">
                    ...
                    <div class="dropdown border-top">
                        <a href="#" class="d-flex align-items-center justify-content-center p-3 link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="https://theme.webtechfocus.com/assets/logos/wtf-logo-square-bbg.svg" alt="mm" width="24" height="24" class="rounded-circle">
                        </a>
                        <ul class="dropdown-menu text-small shadow">
                            <li><a class="dropdown-item" href="#">New project...</a></li>
                            <li><a class="dropdown-item" href="#">Settings</a></li>
