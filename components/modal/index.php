...
<html lang="en" data-bs-theme="auto">
  ...
  <link rel="canonical" href="http://localhost/wtf-library/components/modals/" />
        ...
        <div class="modal-content rounded-4 shadow">
          ...
          <div class="modal-body py-0">
            <p>
              ...
              to the bottom of the viewport like the newer share sheets in iOS.
            </p>
          </div>
          <div
          ...
          <div class="modal-body p-5">
            ...
            <ul class="d-grid gap-4 my-5 list-unstyled small">
              <li class="d-flex gap-4">
                <svg
                  class="bi text-body-secondary flex-shrink-0"
                  width="48"
                  height="48"
                  aria-hidden="true"
                >
              ...
              <li class="d-flex gap-4">
                <svg
                  class="bi text-warning flex-shrink-0"
                  width="48"
                  height="48"
                  aria-hidden="true"
                >
              ...
              <li class="d-flex gap-4">
                <svg
                  class="bi text-primary flex-shrink-0"
                  width="48"
                  height="48"
                  aria-hidden="true"
                >
