...
<html lang="en" data-bs-theme="auto">
  ...
  <link rel="canonical" href="http://localhost/wtf-library/components/list-groups/" />
    <link
      rel="canonical"
      href="https://library.webtechfocus.com/components/jumbotron/"
    />
...
<?php include(SITE_ROOT . '/components/header/wtf-theme.php'); ?>
    ...
    <main>
      <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?> py-4">
        ...
        <div class="p-5 mb-4 bg-body-tertiary rounded-3">
          <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?> py-5">
