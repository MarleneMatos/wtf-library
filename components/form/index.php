...
<body id="wtfTheme" class="wtf-line">
    ...
    <main>
        <section class="<?php include(SITE_ROOT . '/components/content/demo/section-class.php'); ?> "id="checkout-form" class="py-5">
        ...
        <section class="<?php include(SITE_ROOT . '/components/content/demo/section-class.php'); ?> "id="contact-form" class="py-5">
            <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?>">
                <div class="row">
        ...
        <section class="<?php include(SITE_ROOT . '/components/content/demo/section-class.php'); ?> "id="login-form" class="py-5">
            <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?>">
                <div class="row">
