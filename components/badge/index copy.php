...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <link rel="canonical" href="https://library.webtechfocus.com/components/badges/" />
...
<?php include(SITE_ROOT . '/components/header/wtf-theme.php'); ?>
    ...
    <div class="d-flex gap-2 justify-content-center py-5">
      ...
      >
      <span
        class="badge bg-dark-subtle border border-dark-subtle text-dark-emphasis rounded-pill"
        >Dark</span
      >
    </div>
    <hr class="xl" />
