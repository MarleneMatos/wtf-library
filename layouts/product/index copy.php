...
<head>
  ...
  <link rel="canonical" href="http://localhost/wtf-library/layouts/products/" />
...
<body id="wtfTheme" class="wtf-line">
  ...
  <!--
    <footer class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?> py-5">
      <div class="row">
