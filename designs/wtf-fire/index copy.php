...
<head>
    ...
    include(SITE_ROOT . '/components/wtf/wtf-wtf-meta.php'); ?>
    ...
    <title>Web Tech Focus - Online Solutions <?php include(SITE_ROOT . '/components/wtf/wtf-wtf-title.php'); ?></title>
    <?php include(SITE_ROOT . '/components/wtf/wtf-gtm-head.php'); ?>
</head>


<body id="wtfTheme" class="wtf-wtf">
    <?php include(SITE_ROOT . '/components/wtf/wtf-gtm-body.php'); ?>
    <h1 class="visually-hidden">Web Tech Focus - Online Solutions <?php include(SITE_ROOT . '/components/wtf/wtf-wtf-title.php'); ?></h1>
    <?php include(SITE_ROOT . '/components/wtf/wtf-wtf-header.php'); ?>


    <main data-bs-spy="scroll" data-bs-target="#wtfNav" data-bs-smooth-scroll="true" tabindex="0">

        <section class="<?php include(SITE_ROOT . '/components/content/demo/section-class.php'); ?> "id="home" class="hero">
            <div class="bg-video">
                <video class="video-content" autoplay="" muted="" loop="">
                    <source src="https://www.webtechfocus.com/wp-content/themes/wtf-webtechfocus/assets/media/coverr-coding-on-a-laptop-2116-1080p.mp4" type="video/mp4">
                    <source src="https://www.webtechfocus.com/wp-content/themes/wtf-webtechfocus/assets/media/coverr-coding-on-a-laptop-2116-1080p.webm" type="video/webm">
                    Your browser is not supported!
                </video>
            </div>

            <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?> content-center">




                <div class="row d-flex justify-content-center align-items-center text-center">
                    <div class="hero-logo py-2">
                        <svg xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg" version="1.1" id="svg1" width="133.33299" height="54" viewBox="0 0 133.33299 54.000002" sodipodi:docname="wtf-logo.svg" inkscape:version="1.4 (86a8ad7, 2024-10-11)" inkscape:export-filename="wtf-logo-square.png" inkscape:export-xdpi="300" inkscape:export-ydpi="300">
                            <defs id="defs1">
                                <inkscape:path-effect effect="fillet_chamfer" id="path-effect11" is_visible="true" lpeversion="1" nodesatellites_param="F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,4.6110732,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,4.6088111,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1" radius="0" unit="px" method="auto" mode="F" chamfer_steps="1" flexible="false" use_knot_distance="true" apply_no_radius="true" apply_with_radius="true" only_selected="false" hide_knots="false"></inkscape:path-effect>
                                <inkscape:path-effect effect="fillet_chamfer" id="path-effect10" is_visible="true" lpeversion="1" nodesatellites_param="F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,2.0056314,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1" radius="0" unit="px" method="auto" mode="F" chamfer_steps="1" flexible="false" use_knot_distance="true" apply_no_radius="true" apply_with_radius="true" only_selected="false" hide_knots="false"></inkscape:path-effect>
                                ...
                                <inkscape:path-effect effect="fillet_chamfer" id="path-effect6" is_visible="true" lpeversion="1" nodesatellites_param="F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1 @ F,0,0,1,0,0,0,1" radius="0" unit="px" method="auto" mode="F" chamfer_steps="1" flexible="false" use_knot_distance="true" apply_no_radius="true" apply_with_radius="true" only_selected="false" hide_knots="false"></inkscape:path-effect>
                                <color-profile inkscape:label="sRGB IEC61966-2.1" name="sRGB IEC61966-2.1" xlink:href="data:application/vnd.iccprofile;base64," id="color-profile2"></color-profile>
                                <clipPath clipPathUnits="userSpaceOnUse" id="clipPath2">
                                    <path d="M 0,100 H 100 V 0 H 0 Z" transform="translate(-10.5693,-72.503902)" id="path2"></path>
                                </clipPath>
                                <clipPath clipPathUnits="userSpaceOnUse" id="clipPath4">
                                    <path d="M 0,100 H 100 V 0 H 0 Z" transform="translate(-88.228502,-24.486303)" id="path4"></path>
                                </clipPath>
                                <clipPath clipPathUnits="userSpaceOnUse" id="clipPath6">
                                    <path d="M 0,100 H 100 V 0 H 0 Z" transform="translate(-78.828099,-60.442902)" id="path6"></path>
                                </clipPath>
                            </defs>
                            <sodipodi:namedview id="namedview1" pagecolor="#ffffff" bordercolor="#000000" borderopacity="0.25" inkscape:showpageshadow="2" inkscape:pageopacity="0.0" inkscape:pagecheckerboard="0" inkscape:deskcolor="#d1d1d1" inkscape:zoom="6.5100003" inkscape:cx="25.576036" inkscape:cy="50.998461" inkscape:window-width="1920" inkscape:window-height="1112" inkscape:window-x="6" inkscape:window-y="1342" inkscape:window-maximized="1" inkscape:current-layer="layer-MC0" showguides="true">
                                <inkscape:page x="0" y="0" inkscape:label="1" id="page1" width="133.33299" height="54.000004" margin="0.88907868 1.3333334 0.8890667" bleed="0"></inkscape:page>
                                <sodipodi:guide position="54.838708,-10.133637" orientation="0,-1" id="guide11" inkscape:locked="false"></sodipodi:guide>
                            </sodipodi:namedview>
                            <g id="layer-MC0" inkscape:groupmode="layer" inkscape:label="Layer 1">
                                <path id="path5" d="m 0,0 c 0,0.129 0.009,0.261 0.029,0.388 0.196,1.188 0.588,2.113 1.18,2.774 0.843,0.879 2.144,1.319 3.903,1.319 h 1.155 c 1.274,0 2.308,1.034 2.308,2.309 0,1.275 -1.034,2.309 -2.308,2.309 H 3.848 C 1.759,9.099 -0.092,8.439 -1.704,7.12 -3.793,5.396 -4.837,2.832 -4.837,-0.576 V -0.73 c 0,-1.275 -1.034,-2.309 -2.309,-2.309 h -8.52 c -1.274,0 -2.309,1.034 -2.309,2.309 v 2.133 c 0,1.275 -1.033,2.308 -2.308,2.308 h -0.164 c -1.276,0 -2.309,-1.033 -2.309,-2.308 V -0.73 c 0,-1.275 -1.034,-2.309 -2.308,-2.309 0,0 -1.871718,-0.00212 -3.854999,-0.00451 -2.546586,-0.00307 -4.617823,-2.0709109 -4.617645,-4.6175038 C -33.536306,-12.471535 -33.53,-19.32 -33.53,-19.32 c 0,-1.943 -0.412,-3.435 -1.237,-4.48 -0.824,-1.044 -1.951,-1.567 -3.38,-1.567 -1.539,0 -2.768,0.404 -3.683,1.209 -1.063,0.953 -1.594,2.382 -1.594,4.288 v 14.512 c 0,1.275 -1.034,2.308 -2.308,2.308 h -0.331 c -1.274,0 -2.308,-1.033 -2.308,-2.308 V -19.43 c 0,-2.198 -0.532,-3.793 -1.594,-4.782 -0.844,-0.77 -2.053,-1.155 -3.628,-1.155 -1.503,0 -2.639,0.513 -3.408,1.539 -0.807,0.953 -1.209,2.162 -1.209,3.628 l 0,12.5411889 A 4.6088111,4.6088111 135 0 1 -62.818811,-3.05 h -5.635178 l -1.792206,0.011 H -75.519 c -1.264,0 -2.308,-1.016 -2.309,-2.279 v -0.037 -0.033 c 0.001,-1.263 1.045,-2.279 2.308,-2.279 h 10.164 c 1.275,0 2.309,-1.034 2.309,-2.309 v -10.883 c 0,-2.089 0.659,-3.995 1.978,-5.717 1.722,-2.273 4.214,-3.408 7.476,-3.408 1.759,0 3.371,0.403 4.837,1.209 0.503,0.283 0.964,0.596 1.386,0.94 0.876,0.712 2.122,0.727 2.97,-0.02 0.637,-0.562 1.274,-0.996 1.911,-1.305 1.135,-0.549 2.693,-0.824 4.672,-0.824 2.125,0 4.141,0.75 6.046,2.254 2.052,1.648 3.079,3.737 3.079,6.266 v 11.488 c 0,1.275 1.033,2.309 2.308,2.309 h 1.32 c 1.274,0 2.308,-1.034 2.308,-2.309 v -11.199 c 0,-2.423 0.605,-4.351 1.814,-5.782 1.392,-1.652 3.499,-2.477 6.321,-2.477 h 3.793 c 1.275,0 2.308,1.033 2.308,2.309 0,1.274 -1.033,2.308 -2.308,2.308 h -3.683 c -1.174,0 -2.034,0.275 -2.584,0.824 -0.586,0.477 -0.88,1.1 -0.88,1.869 v 12.148 c 0,1.275 1.035,2.309 2.309,2.309 h 8.52 c 1.275,0 2.309,-1.034 2.309,-2.309 v -17.149 c 0,-1.276 1.033,-2.309 2.309,-2.309 h 0.219 c 1.275,0 2.309,1.033 2.309,2.309 v 17.149 c 0,1.275 1.033,2.309 2.309,2.309 h 15.554 c 1.264,0 2.308,1.016 2.309,2.279 v 0.033 0.037 c -0.001,1.263 -1.045,2.279 -2.309,2.279 H 2.309 C 1.033,-3.039 0,-2.005 0,-0.73 Z" style="color:var(--wtf-brand-color);fill: currentColor;font-style:normal;font-variant:normal;font-weight:normal;font-stretch:normal;font-size:medium;line-height:normal;font-family:sans-serif;font-variant-ligatures:normal;font-variant-position:normal;font-variant-caps:normal;font-variant-numeric:normal;font-variant-alternates:normal;font-variant-east-asian:normal;font-feature-settings:normal;font-variation-settings:normal;text-indent:0;text-align:start;text-decoration-line:none;text-decoration-style:solid;text-decoration-color:var(--wtf-brand-color);letter-spacing:normal;word-spacing:normal;text-transform:none;writing-mode:lr-tb;direction:ltr;text-orientation:mixed;dominant-baseline:auto;baseline-shift:baseline;text-anchor:start;white-space:normal;shape-padding:0;shape-margin:0;inline-size:0;clip-rule:nonzero;display:inline;overflow:visible;visibility:visible;isolation:auto;mix-blend-mode:normal;color-interpolation:sRGB;color-interpolation-filters:linearRGB;solid-color:var(--wtf-brand-color);solid-opacity:1;vector-effect:none;fill: currentColor;fill-opacity:1;fill-rule:nonzero;stroke:none;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-dasharray:none;stroke-dashoffset:0;stroke-opacity:1;-inkscape-stroke:none;color-rendering:auto;image-rendering:auto;shape-rendering:auto;text-rendering:auto;enable-background:accumulate;stop-color:var(--wtf-brand-color);stop-opacity:1" transform="matrix(1.3333333,0,0,-1.3333333,105.10413,13.111466)" clip-path="url(#clipPath6)" sodipodi:nodetypes="sccsssssscssssssssssszscscsssssscscscccscccsssscsccccscsssssscssssscsssssssssssscccssss" inkscape:path-effect="#path-effect11" inkscape:original-d="m 0,0 c 0,0.129 0.009,0.261 0.029,0.388 0.196,1.188 0.588,2.113 1.18,2.774 0.843,0.879 2.144,1.319 3.903,1.319 h 1.155 c 1.274,0 2.308,1.034 2.308,2.309 v 0 c 0,1.275 -1.034,2.309 -2.308,2.309 H 3.848 C 1.759,9.099 -0.092,8.439 -1.704,7.12 -3.793,5.396 -4.837,2.832 -4.837,-0.576 V -0.73 c 0,-1.275 -1.034,-2.309 -2.309,-2.309 h -8.52 c -1.274,0 -2.309,1.034 -2.309,2.309 v 2.133 c 0,1.275 -1.033,2.308 -2.308,2.308 h -0.164 c -1.276,0 -2.309,-1.033 -2.309,-2.308 V -0.73 c 0,-1.275 -1.034,-2.309 -2.308,-2.309 0,0 -8.45102,-0.00955 -8.466,-0.011 -0.01498,-0.00145 0,-16.27 0,-16.27 0,-1.943 -0.412,-3.435 -1.237,-4.48 -0.824,-1.044 -1.951,-1.567 -3.38,-1.567 -1.539,0 -2.768,0.404 -3.683,1.209 -1.063,0.953 -1.594,2.382 -1.594,4.288 v 14.512 c 0,1.275 -1.034,2.308 -2.308,2.308 h -0.331 c -1.274,0 -2.308,-1.033 -2.308,-2.308 V -19.43 c 0,-2.198 -0.532,-3.793 -1.594,-4.782 -0.844,-0.77 -2.053,-1.155 -3.628,-1.155 -1.503,0 -2.639,0.513 -3.408,1.539 -0.807,0.953 -1.209,2.162 -1.209,3.628 v 17.15 h -10.243989 l -1.792206,0.011 H -75.519 c -1.264,0 -2.308,-1.016 -2.309,-2.279 v -0.037 -0.033 c 0.001,-1.263 1.045,-2.279 2.308,-2.279 h 10.164 c 1.275,0 2.309,-1.034 2.309,-2.309 v -10.883 c 0,-2.089 0.659,-3.995 1.978,-5.717 1.722,-2.273 4.214,-3.408 7.476,-3.408 1.759,0 3.371,0.403 4.837,1.209 0.503,0.283 0.964,0.596 1.386,0.94 0.876,0.712 2.122,0.727 2.97,-0.02 0.637,-0.562 1.274,-0.996 1.911,-1.305 1.135,-0.549 2.693,-0.824 4.672,-0.824 2.125,0 4.141,0.75 6.046,2.254 2.052,1.648 3.079,3.737 3.079,6.266 v 11.488 c 0,1.275 1.033,2.309 2.308,2.309 h 1.32 c 1.274,0 2.308,-1.034 2.308,-2.309 v -11.199 c 0,-2.423 0.605,-4.351 1.814,-5.782 1.392,-1.652 3.499,-2.477 6.321,-2.477 h 3.793 c 1.275,0 2.308,1.033 2.308,2.309 0,1.274 -1.033,2.308 -2.308,2.308 h -3.683 c -1.174,0 -2.034,0.275 -2.584,0.824 -0.586,0.477 -0.88,1.1 -0.88,1.869 v 12.148 c 0,1.275 1.035,2.309 2.309,2.309 h 8.52 c 1.275,0 2.309,-1.034 2.309,-2.309 v -17.149 c 0,-1.276 1.033,-2.309 2.309,-2.309 h 0.219 c 1.275,0 2.309,1.033 2.309,2.309 v 17.149 c 0,1.275 1.033,2.309 2.309,2.309 h 15.554 c 1.264,0 2.308,1.016 2.309,2.279 v 0.033 0.037 c -0.001,1.263 -1.045,2.279 -2.309,2.279 H 2.309 C 1.033,-3.039 0,-2.005 0,-0.73 Z"></path>
                            </g>
                        </svg>
                    </div>
                    <h2 class="h1">web tech focus</h2>
                    <h3 class="h2">wtf solutions for you</h3>
                </div>

                <div class="row d-flex justify-content-center align-items-center text-center py-5">
                    <div class="col-sm-12 col-md-12">
                        <a href="#services" data-bs-spy="scroll" data-bs-target="#wtfNav" data-bs-smooth-scroll="true" tabindex="0" class="btn btn-lg btn-primary btn-animated">
                            <p class="m-0 p-0">Our Services</p>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <section class="<?php include(SITE_ROOT . '/components/content/demo/section-class.php'); ?> "id="about">
            <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?>">
                <div class="row d-flex justify-content-center align-items-center text-center my-5">
                    <h3 class="h1 h1-wtf">web tech focus</h3>
                </div>



                <div class="row d-flex justify-content-center align-items-center text-center my-5">
                    <p><span style="font-weight: 400">At </span><b>Web Tech Focus</b><span style="font-weight: 400">, we bring over a decade of hands-on experience in web development, software solutions, and interactive design to help businesses thrive in the digital space.</span></p>
                    <p><span style="font-weight: 400">Founded by </span><b>Marlene Matos</b><span style="font-weight: 400">, a seasoned Developer with a background in </span><b>Interactive Media Design</b><span style="font-weight: 400">, Web Tech Focus is built on a solid foundation of creativity, technical expertise, and a deep understanding of how to connect brands with their audiences.</span></p>
                    <p><span style="font-weight: 400">Since 2013, Marlene’s journey through the digital world has spanned multiple industries—from cosmetics to water sports, pharmaceuticals to legal. Along the way, she’s worn many hats: Graphic Designer, Web Developer, UI/UX Designer, and Software Developer. Each chapter has added new layers of insight, allowing us to offer tailored, results-driven solutions for businesses of all sizes.</span><span style="font-weight: 400"><br>
                        </span></p>
                    <p><span style="font-weight: 400">We’re passionate about innovation, committed to quality, and focused on delivering real solutions. Whether you’re launching a startup, scaling your eCommerce, or streamlining your internal systems—we’re here to bring your vision to life.</span></p>
                </div>
                ...
                <div class="row d-flex justify-content-center text-center">
                    <div class="col-sm-12 col-lg-24 col-md-12">
                        <a href="#contact" class="btn btn-lg btn-primary btn-animated py-2" tabindex="0">Contact me today</a>
                    </div>
                </div>
            </div>
            ...
            <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?>">
                <div class="row d-flex justify-content-center">
                    <div class="col-sm-12 col-lg-12 col-md-12">
                        <h3 class="h1 h1-wtf">Previous Experience</h3>
                    ...
                    <div class="col-24 work">
                        ...
                        <div class="work-logos">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 350 56" style="enable-background:new 0 0 350 56;" xml:space="preserve">
                                ...
                                <path class="st0" d="M11.4,25.4v16.4H7.7V21.5c0-0.7,0.2-1.3,0.5-1.7c0.4-0.4,0.9-0.6,1.5-0.6c0.3,0,0.6,0.1,0.8,0.2  c0.3,0.1,0.6,0.3,0.8,0.6l15.8,15.7V19.2h3.8v20.6c0,0.8-0.2,1.3-0.5,1.7c-0.4,0.4-0.8,0.6-1.4,0.6c-0.6,0-1.2-0.3-1.8-0.8  L11.4,25.4z"></path>
                                <path class="st0" d="M44.6,41.8c-1.6,0-3-0.3-4.3-0.9c-1.3-0.6-2.5-1.4-3.5-2.4c-1-1-1.7-2.2-2.3-3.6c-0.5-1.4-0.8-2.9-0.8-4.5  c0-1.7,0.3-3.1,0.8-4.5c0.5-1.4,1.3-2.5,2.3-3.5c1-0.9,2.1-1.7,3.5-2.2c1.3-0.5,2.8-0.8,4.3-0.8H50c1.6,0,3.1,0.3,4.5,0.8  c1.3,0.5,2.5,1.3,3.5,2.3c1,1,1.7,2.1,2.3,3.5c0.5,1.4,0.8,2.8,0.8,4.5c0,1.6-0.3,3.1-0.8,4.5c-0.5,1.4-1.3,2.6-2.3,3.6  c-1,1-2.1,1.8-3.5,2.4c-1.3,0.6-2.8,0.9-4.4,0.9H44.6z M50,37.9c1,0,2-0.2,2.9-0.6c0.9-0.4,1.6-0.9,2.2-1.5c0.6-0.7,1.1-1.4,1.5-2.3  c0.3-0.9,0.5-1.9,0.5-2.9c0-1.1-0.2-2-0.5-2.9c-0.4-0.9-0.8-1.7-1.5-2.3c-0.6-0.6-1.4-1.1-2.2-1.5C52,23.5,51,23.3,50,23.3h-5.4  c-1,0-2,0.2-2.8,0.5c-0.8,0.4-1.6,0.9-2.2,1.5c-0.6,0.6-1.1,1.4-1.4,2.3c-0.4,0.9-0.5,1.9-0.5,2.9c0,1,0.2,2,0.5,2.9  c0.3,0.9,0.8,1.7,1.4,2.3c0.6,0.6,1.4,1.2,2.2,1.5c0.9,0.4,1.8,0.6,2.8,0.6H50z"></path>
                                <path class="st0" d="M85.5,41.8l-5.7-6.2h-8.4v-3.4h9.3c1.4,0,2.5-0.4,3.2-1.1c0.7-0.8,1.1-1.9,1.1-3.4c0-1.5-0.4-2.6-1.1-3.3  c-0.8-0.7-1.8-1-3.2-1H68.5v18.5h-3.9V19.4h16.1c1.3,0,2.4,0.2,3.4,0.6c1,0.4,1.9,0.9,2.6,1.6c0.7,0.7,1.2,1.6,1.6,2.6  c0.4,1,0.6,2.1,0.6,3.4c0,1.9-0.4,3.4-1.2,4.7c-0.8,1.3-2,2.2-3.4,2.7l6.8,6.8H85.5z"></path>
                                <path class="st0" d="M99.7,41.8V23.3h-8.5v-3.9h20.9v3.9h-8.5v18.5H99.7z"></path>
                                <path class="st0" d="M114.7,41.9V19.4h3.9v22.5H114.7z M132.8,41.9v-9.8h-11.3v-3.5h11.3v-9.3h3.9v22.5H132.8z"></path>
                                <path class="st0" d="M141.2,41.8V19.4h20.1v3.9h-16.2v14.6h16.2v3.9H141.2z M147.9,32.1v-3.3h12.4v3.3H147.9z"></path>
                                <path class="st0" d="M185.7,41.8l-5.7-6.2h-8.4v-3.4h9.4c1.4,0,2.5-0.4,3.2-1.1c0.7-0.8,1.1-1.9,1.1-3.4c0-1.5-0.4-2.6-1.1-3.3  c-0.7-0.7-1.8-1-3.1-1h-12.2v18.5h-3.9V19.4H181c1.3,0,2.4,0.2,3.4,0.6c1,0.4,1.9,0.9,2.6,1.6c0.7,0.7,1.2,1.6,1.6,2.6  c0.4,1,0.5,2.1,0.5,3.4c0,1.9-0.4,3.4-1.2,4.7c-0.8,1.3-1.9,2.2-3.4,2.7l6.8,6.8H185.7z"></path>
                                <path class="st0" d="M196.7,25.4v16.4H193V21.5c0-0.7,0.2-1.3,0.5-1.7c0.4-0.4,0.9-0.6,1.5-0.6c0.3,0,0.6,0.1,0.9,0.2  c0.3,0.1,0.5,0.3,0.8,0.6l15.8,15.7V19.2h3.7v20.6c0,0.8-0.2,1.3-0.5,1.7c-0.4,0.4-0.8,0.6-1.4,0.6c-0.6,0-1.2-0.3-1.8-0.8  L196.7,25.4z"></path>
                                <path class="st0" d="M229.1,41.8V19.4h13c1.6,0,3,0.3,4.4,0.8c1.4,0.5,2.5,1.3,3.5,2.3c1,1,1.7,2.1,2.3,3.5c0.5,1.4,0.8,2.8,0.8,4.5  c0,1.6-0.3,3.1-0.8,4.5c-0.6,1.4-1.3,2.6-2.3,3.6c-1,1-2.1,1.8-3.5,2.4c-1.3,0.6-2.8,0.9-4.4,0.9H229.1z M242.1,37.9  c1,0,1.9-0.2,2.8-0.6c0.8-0.4,1.6-0.9,2.2-1.5c0.6-0.7,1.1-1.4,1.5-2.3c0.3-0.9,0.5-1.9,0.5-2.9c0-1.1-0.2-2-0.5-2.9  c-0.4-0.9-0.8-1.7-1.5-2.3c-0.6-0.6-1.4-1.1-2.2-1.5c-0.8-0.3-1.8-0.5-2.8-0.5H233v14.6H242.1z"></path>
                                <path class="st0" d="M256.4,41.8V19.4h3.9v22.4H256.4z"></path>
                                <path class="st0" d="M262.5,19.4h4.8l10.2,17.3l10.2-17.3h4.5l-12.9,21.5c-0.2,0.4-0.5,0.7-0.8,0.9c-0.3,0.2-0.7,0.3-1.1,0.3  c-0.4,0-0.8-0.1-1.1-0.3c-0.3-0.2-0.6-0.5-0.8-0.9L262.5,19.4z"></path>
                                <g>
                                    ...
                                    <path class="st1" d="M277.6,25.5L266,6h4.8l6.8,12.2l7-12.1h4.5L277.6,25.5z"></path>
                                </g>
                                <path class="st0" d="M294.9,41.8V19.4h20.1v3.9h-16.2v14.6H315v3.9H294.9z M301.6,32.1v-3.3h12.4v3.3H301.6z"></path>
                                <path class="st0" d="M339.4,41.8l-5.7-6.2h-8.4v-3.4h9.4c1.4,0,2.5-0.4,3.2-1.1c0.7-0.8,1.1-1.9,1.1-3.4c0-1.5-0.4-2.6-1.1-3.3  c-0.7-0.7-1.8-1-3.2-1h-12.2v18.5h-3.9V19.4h16.1c1.3,0,2.4,0.2,3.4,0.6c1,0.4,1.9,0.9,2.6,1.6c0.7,0.7,1.2,1.6,1.6,2.6  c0.4,1,0.5,2.1,0.5,3.4c0,1.9-0.4,3.4-1.2,4.7c-0.8,1.3-2,2.2-3.4,2.7l6.8,6.8H339.4z"></path>
                            </svg>
                        </div>
                        <div class="work-logos">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 139 31" data-id="common" class="top-area-app-emotion-cache-key-bfihcq">
        ...
        <section class="<?php include(SITE_ROOT . '/components/content/demo/section-class.php'); ?> "id="services">
            <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?>">
                <div class="row d-flex justify-content-center align-items-center text-center py-5">
                    <h3 class="h1 h1-wtf">Services</h3>

                    <!-- <h4 class="2">Stuff that wtf is really good at</h4> -->
                </div>
                ...
                <div class="row justify-content-center align-items-center text-center py-5">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 feature-icon--fw py-2">
                        <svg>
                            <use xlink:href="https://www.webtechfocus.com/wp-content/themes/wtf-webtechfocus/assets/icons/icomoon-elegant-line/sprite.svg#icon-tools"></use>
                        </svg>


                        <h5 class="h5 h5-wtf">Design</h5>
                        <p>Design of banners, adverts &amp; sliders for websites. Design for web, make sure you user has the best experience while navigating through your website, from whatever device his using or his settings.</p>
                        <!-- <a class="w-100 btn btn-primary text-white" href="">Find out more</a> -->
                    </div>
                    <div class="col-12 col-md-6 col-lg-3 feature-icon--fw py-2">
                        <svg>
                            <use xlink:href="https://www.webtechfocus.com/wp-content/themes/wtf-webtechfocus/assets/icons/icomoon-elegant-line/sprite.svg#icon-browser"></use>
                        </svg>


                        <h5 class="h5 h5-wtf">Development</h5>
                        <p>Web tech focus is specialized in creating dynamic, user-friendly websites using company-leading open-source CMS platforms like <b>Umbraco</b> and <b>WordPress</b>. Whether it's building from scratch or customizing existing themes, I ensure your website is both functional and visually engaging.</p>
                        <!-- <a class="w-100 btn btn-primary text-white" href="">Find out more</a> -->
                    </div>
                    <div class="col-12 col-md-6 col-lg-3 feature-icon--fw py-2">
                        <svg>
                            <use xlink:href="https://www.webtechfocus.com/wp-content/themes/wtf-webtechfocus/assets/icons/icomoon-elegant-line/sprite.svg#icon-envelope"></use>
                        </svg>


                        <h5 class="h5 h5-wtf">Support</h5>
                        <p><!-- wp:html -->
                        </p>
                        <p>Create impactful email campaigns that drive engagement and conversions. Web tech focus has experience
                            with multiple platforms, designing and building custom HTML emails optimized for compatibility with <b>Outlook</b>,
                            <b>Gmail</b>, and <b>Yahoo Mail</b>. From newsletters to automated sequences, to ensure that
                            your messages deliver results.
                        </p>
                        <!-- /wp:html -->
        ...
        <section class="<?php include(SITE_ROOT . '/components/content/demo/section-class.php'); ?> "id="contact" class="bg-primary py-5">
            <div class="<?php include(SITE_ROOT . '/components/content/demo/container-class.php'); ?>">
                ...
                <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border border-primary-subtle shadow-lg" style="background: var(--wtf-body-bg);">
                    <div class="col-lg-14 p-3 p-lg-5 pt-lg-3">
                        <h5 class="py-2" style="color: var(--wtf-body);">Looking for a wtf solution?</h5>

                        <div class="wpcf7 no-js" id="wpcf7-f163-o2" lang="en-GB" dir="ltr" data-wpcf7-id="163">
                            ...
                            <form action="/#wpcf7-f163-o2" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
                                ...
                                <div class="row d-flex justify-content-center py-2 g-3">
                                    <div class="form-floating">
                                        <p><span class="wpcf7-form-control-wrap" data-name="your-name"><input size="40" maxlength="400" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required required form-control" aria-required="true" aria-invalid="false" placeholder="Name" value="" type="text" name="your-name" fdprocessedid="ihtzy"></span>
                                        </p>
                                    </div>
                                </div>
                                <div class="row d-flex justify-content-center py-2 g-3">
                                    <div class="form-floating">
                                        <p><span class="wpcf7-form-control-wrap" data-name="your-email"><input size="40" maxlength="400" class="wpcf7-form-control wpcf7-email wpcf7-validates-as-required wpcf7-text wpcf7-validates-as-email required form-control" aria-required="true" aria-invalid="false" placeholder="Email" value="" type="email" name="your-email" fdprocessedid="3y2i2"></span>
                                        </p>
                                    </div>
                                </div>
                                <div class="row d-flex justify-content-center py-2 g-3">
                                    <div class="form-floating">
                                        <p><span class="wpcf7-form-control-wrap" data-name="your-message"><textarea cols="40" rows="10" maxlength="2000" class="wpcf7-form-control wpcf7-textarea required form-control" aria-invalid="false" placeholder="Message" name="your-message"></textarea></span>
                                        </p>
                                    </div>
                                </div>
                                <div class="row d-flex justify-content-center py-2 g-3">
                                    <p><input class="wpcf7-form-control wpcf7-submit has-spinner btn btn-lg btn-primary btn-animated py-2" type="submit" value="Submit">
                                    </p>
                                </div>
                                <div class="wpcf7-response-output" aria-hidden="true"></div>

                                <div class="row d-flex justify-content-center py-2 g-3">
                                    <p><input class="wpcf7-form-control wpcf7-submit has-spinner btn btn-lg btn-form" type="submit" value="Submit" fdprocessedid="x9sbmc">
                                    </p>
                                </div>
                    ...
                    <div class="col-lg-3 offset-lg-2 p-0 overflow-hidden shadow-lg">
                        <img class="rounded-3" src="https://www.webtechfocus.com/wp-content/themes/wtf-webtechfocus/assets/media/wtf-site.png" alt="wtf-site" width="720">
                    </div>
                </div>
