...
<html lang="en" class="h-100" data-bs-theme="auto">
  <head>
    ...
    <title>Cover Template <?php include(SITE_ROOT . '/components/wtf/wtf-wtf-title.php'); ?></title>
    <link
      rel="canonical"
      href="https://library.webtechfocus.com/components/cover/"
    />
 ...
 <body id="wtfTheme" class="wtf-line d-flex h-100 text-center text-bg-dark">
